...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        String correo = nombreInput.getText().toString();
        String tipo = precioInput.getText().toString();
        String motivo= detallesInput.getText().toString();
        ...
        if (mediaFileUri == null) {
            ...
            RequestBody nombrePart = RequestBody.create(MultipartBody.FORM, correo);
            RequestBody precioPart = RequestBody.create(MultipartBody.FORM, tipo);
            RequestBody detallesPart = RequestBody.create(MultipartBody.FORM, motivo);

            call = service.createSolicitudWithImage(nombrePart, precioPart, detallesPart, imagenPart);
        }
